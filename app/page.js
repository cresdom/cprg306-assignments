  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-linear-to-t from-purple-400 to-fuchsia-100">
      ...
      <main className="space-y-4">
        ...
        <div className="bg-white px-6 py-4 rounded shadow">
          <Link href="week-4" className="text-purple-600 font-light hover:underline">Week 4 Assignment</Link>
        </div>

        <div className="bg-white px-6 py-4 rounded shadow">
          <Link href="week-5" className="text-purple-600 font-light hover:underline">Week 5 Assignment</Link>
        </div>

        <div className="bg-white px-6 py-4 rounded shadow">
          <Link href="week-6" className="text-purple-600 font-light hover:underline">Week 6 Assignment</Link>
        </div>
        ...
        <div className="bg-white px-6 py-4 rounded shadow">
          <Link href="week-10" className="text-purple-600 font-light hover:underline">Week 10 Assignment</Link>
        </div>
      </main>
    </div>
  );
